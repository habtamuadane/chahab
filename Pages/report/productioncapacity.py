...
class Productioncapacity:
    ...
    def show(self):
        st.title("🌍 Industry Production capacity Report ")
        ...
        st.divider()
        st.subheader("📦 Industry Production capacity Records Summary")
