...
class Extension:
    ...
    def show(self):
        st.title("🌍 Industry Extension Report ")

        st.subheader("➕ Add New Industry Extension Record")
        with st.form("extension_form", clear_on_submit=True):
        ...
        st.divider()
        st.subheader("📦 Industry Extension Records Summary")
