...
class Importsubstitution:
    DB_FILE = "substitution_data.db"
    ...
    def show(self):
        st.title("🌍 Industry Grow Report ")

        st.subheader("➕ Add New Industry Import Sustitution Record")
